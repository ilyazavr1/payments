...
<c:choose>
                        ...
                        <c:if test="${card.blocked == false}">
                            <div class="col-sm-4 py-2">
                                <div class="card h-100 border-primary">
                                    <div class="card-body">
                                        <h3 class="card-title"><cardFormat:formatCardNumber
                                                number="${card.number}"/></h3>
                                        ...
                                        <div>
                                            <form style="float: left; width: 40%" action="${Path.CARD_TOP_UP_PATH}"
                                                ...
                                                <input style="background-color: lightgreen" type="submit"
                                                       ...
                                                       value="<fmt:message key="topUp"/>">
                                            </form>

                                            <form style="float: right; width: 60%" action="${Path.CARD_BLOCK_PATH}"
                                                  method="post">
                                                <input type="hidden" name="cardId" value="${card.id}">
                                                <input style="margin-left: 70px; background-color: lightcoral"
                                                       type="submit"
                                                       class="btn btn-outline-secondary"
    ...
    <c:otherwise>
        ...
        <h1 style="text-align:center"><fmt:message key="youHaveNoCards"/> <a style="text-align:center" class="nav-link" href="${Path.CARD_CREATE_PATH}"><fmt:message key="navBar.makeCard"/></a></h1>
        </div>
