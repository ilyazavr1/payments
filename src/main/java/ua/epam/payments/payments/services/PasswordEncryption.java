...
public class PasswordEncryption {
    ...
    public static boolean isPasswordCorrect(String inputPassword, String hashedPassword) throws DecoderException, NoSuchAlgorithmException, InvalidKeySpecException {
